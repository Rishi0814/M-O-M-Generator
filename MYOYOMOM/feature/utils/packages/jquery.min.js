...
!(function (e, t) {
  ...
  function Oe(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      y = g(v);
    if (y || (p > 1 && "string" == typeof v && !h.checkClone && De.test(v)))
    ...
    if (
      p &&
      ((o = (i = ve(t, e[0].ownerDocument, !1, e, r)).firstChild),
      1 === i.childNodes.length && (i = o),
      o || r)
    ) {
      for (u = (s = b.map(de(i, "script"), je)).length; f < p; f++)
        (l = i),
          f !== d &&
          ...
          (l = s[f]),
            fe.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : m(l.textContent.replace(Ne, ""), c, l));
    }
    return e;
  }
  function Pe(e, t, n) {
  ...
  b.extend(b.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        if (!o && !d.noBubble && !v(i)) {
          for (
            l = d.delegateType || m, gt.test(l + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            y.push(s), (u = s);
        ...
        return (
          ...
          o ||
            ...
            (c &&
              ...
              ((u = i[c]) && (i[c] = null),
              (b.event.triggered = m),
              t.isPropagationStopped() && h.addEventListener(m, vt),
              i[m](),
              t.isPropagationStopped() && h.removeEventListener(m, vt),
  ...
  b.ajaxSetup({
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = $e(h.pixelPosition, function (e, n) {
        if (n)
          return (n = We(e, t)), Me.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
